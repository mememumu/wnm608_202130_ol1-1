	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">Krisewelry Jewelry</a>
			</div>
	...
	<br>
				<div class="panel panel-info" >
					...
					<div id="get_product"></div>
						<!--<div class="col-md-4">
							<div class="panel panel-info">
								<div class="panel-heading">Lotus Necklace</div>
								<div class="panel-body"><img src="assets/prod_images/lotus.jpg"></div>
